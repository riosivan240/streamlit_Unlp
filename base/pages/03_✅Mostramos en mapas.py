...
st.title("Mapa")
st.write("En el mapa se puede ver segun la opcion elegida donde estan en el país cada tipo de area protegida")
mapa = generar_mapa()
